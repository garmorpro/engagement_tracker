        ...
        <div class="col">
            ...
            <div class="card position-relative" style="background-color: rgb(225,238,253); border-color: rgb(225,228,232); overflow: hidden;">
                <div class="card-body">
                    ...
                    <i class="bi bi-graph-up-arrow position-absolute" style="font-size: 5rem; top: 110px; right: -10px; color: rgba(30,117,255,0.15); z-index: 0;"></i>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="card position-relative" style="background-color: rgb(255,241,224); border-color: rgb(225,228,232); overflow: hidden;">
                <div class="card-body">
                    ...
                    <!-- Decorative Icon behind -->
                    <i class="bi bi-clock position-absolute" style="font-size: 5rem; top: 110px; right: -10px; color: rgba(255,92,0,0.15); z-index: 0;"></i>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="card position-relative" style="background-color: rgb(226,253,237); border-color: rgb(225,228,232); overflow: hidden;">
                <div class="card-body">
                    ...
                    <!-- Decorative Icon behind -->
                    <i class="bi bi-check2-circle position-absolute" style="font-size: 5rem; top: 110px; right: -10px; color: rgba(0,194,81,0.15); z-index: 0;"></i>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="card position-relative" style="background-color: rgb(255,231,231); border-color: rgb(225,228,232); overflow: hidden;">
                <div class="card-body">
                    ...
                    <!-- Decorative Icon behind -->
                    <i class="bi bi-exclamation-triangle position-absolute" style="font-size: 5rem; top: 110px; right: -10px; color: rgba(255,35,52,0.15); z-index: 0;"></i>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="card position-relative" style="background-color: rgb(247,236,254); border-color: rgb(225,228,232); overflow: hidden;">
                <div class="card-body">
                    ...
                    <!-- Decorative Icon behind -->
                    <i class="bi bi-calendar2 position-absolute" style="font-size: 5rem; top: 110px; right: -10px; color: rgba(172,63,255,0.15); z-index: 0;"></i>
                </div>
            </div>
        </div>
