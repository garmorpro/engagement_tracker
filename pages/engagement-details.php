            ...
            <div class="d-flex justify-content-between align-items-start mb-5 mt-2">
              ...
              <div class="d-flex flex-column">
                ...
                <div class="mb-2 d-flex align-items-center flex-wrap gap-2">
                  <!-- Engagement ID -->
                  <span class="badge" style="background-color: rgb(252,252,252); border: rgb(229,231,235); color: rgb(0,0,0); font-weight: 200px !important;"><?php echo htmlspecialchars($eng['eng_idno'] ?? ''); ?></span>
