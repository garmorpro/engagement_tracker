<!-- Add DOL Modal -->
<div class="modal fade" id="addDOLModal" tabindex="-1" aria-labelledby="addDOLModalLabel" aria-hidden="true">
...
<!-- Edit DOL Modal -->
<div class="modal fade" id="editDOLModal" tabindex="-1" aria-labelledby="editDOLModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <form id="editDOLForm">
        <div class="modal-header">
