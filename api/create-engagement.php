...
try {
    ...
    $query = "INSERT INTO engagements (
        ...
        eng_as_of_date, eng_archive, eng_last_communication, eng_notes, eng_status, eng_created, eng_updated
    ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())";
    ...
    $stmt->bind_param(
        ...
        $eng_name, $eng_poc, $eng_location, $eng_repeat, $eng_audit_type,
        $eng_soc_type, $eng_scope, $eng_tsc, $eng_start_period, $eng_end_period,
        $eng_as_of_date, $engArchive, $engLastCommunication, $eng_notes, $eng_status
    );
